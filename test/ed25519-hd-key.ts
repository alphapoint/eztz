  ...
  describe('Test vectors', () => {
    ...
    describe('Vector 1', () => {
      it('should have valid keys for vector 1 seed hex', () => {
        ...
        expect(key.toString('hex')).toEqual('2b4be7f19ee27bbf30c667b642d5f4aa69fd169872f8fc3059c08ebae2eb19e7');
      ...
      vector_1.forEach(vector => {
        it(`should valid for ${vector.path}`, async () => {
          ...
          expect({
            ...
            publicKey: (await getKeyPair(key, true)).toString('hex')
          }).toEqual(vector);
        });
      });
    });
    ...
    describe('Vector 2', () => {
      it('should have valid keys for vector 2 seed hex', () => {
        ...
        expect(key.toString('hex')).toEqual('171cb88b1b3c1db25add599712e36245d75bc65a1a5c9e18d76f9f2b1eab4012');
