...
export const tzScan = {
  ...
  async query(e: string, o?: object | string, t?: any): Promise<any> {
    ...
    if (this.debugMode) console.debug('TzScan request:', e, o);

    if (t === 'POST') {
      options.headers = { 'Content-Type': 'application/json' };
      if (o !== undefined) options.body = JSON.stringify(o);
    }
    ...
    if (this.debugMode) console.debug('TzScan response:', e, o, r);
